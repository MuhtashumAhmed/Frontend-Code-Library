...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "relative flex items-center justify-between gap-2 border h-12 rounded-md px-3",
        className,
      )}
      {...props}
    >
      ...
      <div className="flex items-center gap-1">
        ...
        {value && (
          <div
            ...
            className="flex items-center justify-center rounded-sm p-1 cursor-pointer hover:bg-muted"
          >
...
<Select value={category} onValueChange={handleCategory}>
                  <SelectTrigger
                    className="w-[180px] active:border-myBlue  focus:border-myBlue "
                    value={category}
                    onClear={() => setCategory("")}
                  >
                  ...
                  <SelectContent position="popper">
                    {categories?.data.map((cat) => (
                      <SelectItem
                        key={cat}
                        value={cat}
                        className="capitalize focus:bg-myBlue focus:text-white"
                      >
                        {cat}
                      </SelectItem>
                    ))}
